// src/pages/Reservas/OlvidePasswordClientePage.tsx
...
export function OlvidePasswordClientePage() {
  ...
  const handleSubmit = async (values: typeof form.values) => {
    setLoading(true);
    try {
      await clienteAuthService.olvidePassword(tenant.slug, values.email);
    } finally {
      setLoading(false);
      ...
      <Stack maw={360} w="100%" gap="md">
        ...
        {enviado ? (
          ...
          <>
            ...
            <Anchor component={Link} to={`/reservas/${slug}/login`} ta="center">
              Volver a iniciar sesión
            </Anchor>
          </>
        )}
